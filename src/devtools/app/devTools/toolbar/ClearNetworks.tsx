...
export const ClearNetworks = () => {
	const { onClearNetworks } = useDevToolsNetwork();
	return (
		<svg onClick={onClearNetworks} className={icon} aria-hidden="true" viewBox="0 0 24 24">
			<title>Clear network requests</title>
